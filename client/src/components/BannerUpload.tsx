    ...
    <div className="inline-block relative z-50">
      ...
      {!selectedFile ? (
        <Button
          ...
          variant="outline"
          size="sm"
          className="banner-upload-btn bg-background/90 hover:bg-background text-foreground !border !border-solid !border-border hover:!border-border focus:!border-border"
          type="button"
